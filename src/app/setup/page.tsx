...
export default async function SetupPage() {
  const calendarReady = await tableExists('editorial_calendar');
  const commentsReady = await tableExists('blog_comments');
  const metricsReady = await tableExists('blog_metrics');
  const brokenLinksReady = await tableExists('blog_broken_links');
